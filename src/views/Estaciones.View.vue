  ...
  <div class="p-4 sm:p-8 bg-gray-100 min-h-screen w-full">
    ...
    <div class="p-4 bg-white rounded-b-lg shadow-md">
      ...
      <div v-if="showModalEditar" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 p-4">
        <div class="bg-gray-800 p-8 rounded-lg shadow-md w-full max-w-3xl bg-opacity-75">
          ...
          <form @submit.prevent="editarEstacion">
            <div class="grid grid-cols-1 gap-4 mb-4">
              <div>
                ...
                <input v-model="estacionActual.nombre" id="nombre" type="text" class="w-full px-3 py-2 rounded bg-white text-gray-800">
              </div>
              <div>
                <label for="ubicacion" class="block text-white mb-2">Ubicación</label>
                <input v-model="estacionActual.ubicacion" id="ubicacion" type="text" class="w-full px-3 py-2 rounded bg-white text-gray-800">
              </div>
              <div>
                <label for="capacidad" class="block text-white mb-2">Capacidad</label>
                <input v-model="estacionActual.capacidad" id="capacidad" type="number" class="w-full px-3 py-2 rounded bg-white text-gray-800">
              </div>
              <div>
                <label for="estado" class="block text-white mb-2">Estado</label>
                <select v-model="estacionActual.estado" id="estado" class="w-full px-3 py-2 rounded bg-white text-gray-800">
      ...
      <div v-if="showModalNuevo" class="fixed inset-0 flex items-center justify-center bg-cover bg-center bg-no-repeat bg-image">
        <div class="bg-gray-800 p-8 rounded-lg shadow-md w-full max-w-3xl bg-opacity-75">
          <h2 class="text-2xl font-bold text-center text-white mb-6">Nueva Estación</h2>
          <form @submit.prevent="agregarEstacion">
            <div class="grid grid-cols-1 gap-4 mb-4">
              <div>
                <label for="nombreNuevo" class="block text-white mb-2">Nombre</label>
                <input v-model="nuevaEstacion.nombre" id="nombreNuevo" type="text" class="w-full px-3 py-2 rounded bg-white text-gray-800">
              </div>
              <div>
                <label for="ubicacionNuevo" class="block text-white mb-2">Ubicación</label>
                <input v-model="nuevaEstacion.ubicacion" id="ubicacionNuevo" type="text" class="w-full px-3 py-2 rounded bg-white text-gray-800">
              </div>
              <div>
                <label for="capacidadNuevo" class="block text-white mb-2">Capacidad</label>
                <input v-model="nuevaEstacion.capacidad" id="capacidadNuevo" type="number" class="w-full px-3 py-2 rounded bg-white text-gray-800">
              </div>
              <div>
                <label for="estadoNuevo" class="block text-white mb-2">Estado</label>
